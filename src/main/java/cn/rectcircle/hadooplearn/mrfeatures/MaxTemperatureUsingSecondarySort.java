...
import cn.rectcircle.hadooplearn.ioapi.IntPair;
import cn.rectcircle.hadooplearn.iotypes.JobBuilder;
import cn.rectcircle.hadooplearn.mrunit.NcdcRecordParser;

// vv MaxTemperatureUsingSecondarySort
/*
 （3）表示如何进行多维全局排序（如按照第一个值升序、第二个值降序）
 */
